...
import pic from "../../../images/portfilo/50.jpg";
import icon from "../../../images/icon2/1.png";
      ...
      <div className="container-onecard">
        <div className="card card1">
          <div className="image-cards">
            <div>
              <img className="img-card-zero" src={pic} />
            </div>
          </div>
          <div className="m-2">
            <div className="text-cardd">
              ...
              <h4>
                Personal Website: Programmer and website designer with more than
                2 years of experience in web development, testing and
                troubleshooting, familiarity with the user interface Also, more
                than 5 years of experience in the field of graphics.
              </h4>
            </div>
          </div>
        </div>
