...
import pic from "../../../images/portfilo/31.jpg";
      ...
      <div className="card card1">
        ...
        <div className="m-2">
          <div className="text-cardd">
            ...
            <h4> We have started to operate and provide services since 1377. All raw materials are of quality and well-known brands</h4>
          </div>
        </div>
      </div>
    </div>
