...
import pic from "../../../images/portfilo/14.jpg";
import icon from "../../../images/icon2/2.png";
  ...
  return (
    ...
    <div className="container-onecard">
      ...
      <div className="card card1">
        <div className="image-cards logo-card">
          <div>
            <img className=" logo-card" src={pic} />
          </div>
        </div>
        <div className="m-2">
          <div className="text-cardd">
            ...
            <h4> Kavash Educational Institute is by your side for ease of learning, along with an experienced team of teachers and top graduates.</h4>
          </div>
        </div>
      </div>
    </div>
