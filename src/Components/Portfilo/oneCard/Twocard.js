...
import pic from "../../../images/portfilo/32.jpg";
      ...
      <div className="card card1">
        ...
        <div className="m-2">
          <div className="text-cardd">
            ...
            <h4>Saber Nuts and Dried Fruits by supplying high-quality, hand-picked and healthy products, with online ordering of all kinds of Iranian and foreign nuts and dried fruits and chocolates</h4>
          </div>
        </div>
      </div>
    </div>
