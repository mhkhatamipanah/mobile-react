...
import pic from "../../../images/portfilo/11.jpg";
      ...
      <div className="card card1">
        ...
        <div className="m-2">
          <div className="text-cardd">
            ...
            <h4> Designing and manufacturing all kinds of wooden artefacts with the written guarantee of the Smile brand, sending from Tehran (Pakdasht) to all over the country</h4>
          </div>
        </div>
      </div>
    </div>
