...
import pic from "../../../images/portfilo/13.jpg";
      ...
      <div className="card card1">
        ...
        <div className="m-2">
          <div className="text-cardd">
            ...
            <h4>We are a manufacturer of all kinds of wooden products ordered by customers in Gilan, with 40 years of production experience, we ship all over the country</h4>
          </div>
        </div>
      </div>
    </div>
